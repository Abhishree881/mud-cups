    ...
    const rData = [
        {
            ...
            price: 220.00,
            imgUrl: 'https://s3.amazonaws.com/static.realcaliforniamilk.com/media/recipes_2/paneer-tikka-masala.jpg',
    ...
    return (
        <div className='w-[100vw] h-[100vh] flex justify-center'>
            <div className='w-full max-w-[450px] h-full flex flex-col'>
                ...
                <div className='overflow-scroll h-[110px] my-[10px] px-[12px] flex gap-[12px]'>
